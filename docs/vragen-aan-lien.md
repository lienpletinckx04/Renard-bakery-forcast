...
2. **Geen commissie en geen netto-uitbetaling.** Dit is de belangrijkste. Wat er staat is de verkoopwaarde vóór inhouding. Zonder de commissie blijft de marge op Deliveroo onbeschikbaar — en dan tonen we haar als onbeschikbaar mét reden, niet als schatting. Bij TGTG kenden we die wig wél, uit de maandfactuur (TGTG is sinds 18 sep 2026 uit scope).
3. **Geen btw-uitsplitsing.** De verkoopwaarde is wat de klant betaalt. Het canonieke veld heet `omzet_excl_btw`. Bij een bakkerij lopen 6 % (brood, gebak) en 21 % (dranken) door elkaar, dus dit is niet met één deling op te lossen. Dit was dezelfde onbeantwoorde vraag als bij TGTG, waar ze destijds als voorbehoud op het scherm stond.
